  ...
  <b-container fluid>
    ...
    <b-row class="mt-3">
      <b-col cols="6" class="text-right">
        <button type="button" class="btn btn-pill-accent shadow">
          Recargar datos
        </button>
      </b-col>
...
export default Vue.extend({
  name: "DerivacionCreacionTablaFiltros",
  data() {
    return {
      items: [{ alerta: "--", id: "--", prioritaria: "--" }],
      fields: [
        { key: "prioritaria", label: "Prioritaria" },
        { key: "alerta", label: "Alerta Búsqueda" },
        { key: "seguimiento", label: "Comentario Seguimiento" },
        { key: "id", label: "id" },
        { key: "ssalud", label: "Servicio de Salud" },
        { key: "origen", label: "Origen" },
        { key: "rut", label: "RUT Paciente" },
        { key: "paciente", label: "Paciente" },
        { key: "edada", label: "Edad Años" },
        { key: "edadm", label: "Edad Meses" },
        { key: "edadd", label: "Edad Días" },
        { key: "tdestino", label: "Tipo Destino" },
        { key: "destino", label: "Destino" },
        { key: "tcama", label: "Tipo Cama" },
        { key: "especialidad", label: "Especialidad" },
        { key: "horacreación", label: "Hora Creación" },
        { key: "fechacreación", label: "Fecha Creación" },
        { key: "responsable", label: "Responsable" },
        { key: "rol", label: "Rol" },
        { key: "diagnostico", label: "Diagnóstico" },
        { key: "pacientecrónico", label: "Paciente Crónico" },
        { key: "ges", label: "GES" },
        { key: "convenio", label: "Convenio" },
        { key: "tipocompra", label: "Tipo Compra" },
        { key: "idanterior", label: "Id Anterior" },
